...
void encryptProcessor (ThreadControl& tc) {
    while(1) {
        pair <int, vector<string>> workToDo;
        {
            ...
            cout << "(" << this_thread::get_id() << ") Decrypting txt #" << workToDo.first << endl;
            tc.workQ.pop();
        }
...
int main() {
    ...
    cout << "Enter the name of the text file that you want to decrypt: " << endl;
    cin >> fileName;
    ifstream is;
    is.open(fileName);
     
    cout << "Enter the name of the text file where the decryption will be stored: " << endl;
    cin >> fileName2;
